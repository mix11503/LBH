 ...
 * @author Joe's
 */
public class mtnProgress extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String target = "/mtnProgressSearch.jsp";
        if(mtnId != null || mtnId.equals("")==false){
            ...
            if(mtn!=null){
            //    if(mtn.getMtn_status().equalsIgnoreCase("done")==false){
                    request.setAttribute("mtn", mtn);
                    target = "/mtnViewProgress.jsp";
            //    }else{
            //        message = "Couldn't find in process form";    
            //    }
            }else{
                message = "It's null!";
            }
