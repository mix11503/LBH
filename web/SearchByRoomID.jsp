<%-- 
    Document   : SearchByRoomID
    Created on : Apr 29, 2017, 10:35:56 PM
    Author     : Joe's
--%>
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper">   
                    ...
                    <form action="MTNSearchRoomAdmin" method="get">
                        <h3 align="right">Enter Room No.</h3><div align="right"><input type="number" name="id"> <input type="submit" value="search"></div>
                    </form>
