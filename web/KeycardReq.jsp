                ...
                <section class="wrapper">                    
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 desc">
                                <div class="white-panel pn donut-chart">
                                    <div class="white-header">
                                        <h3>KeyCard ID : ${k.keyId}</h3>
                                    </div>

                                    <div class="row">
                                        <div class="col-sm-12">

                                            <h3>Status : ${k.keyStatus} </h3>
                                            <br>
                                            <c:choose>
                                                <c:when test="${k.keyStatus == 'notAvailable'}">    
                                                    <center>                                         
                                                        <button type="button" onclick="requestNewKeycard(${k.keyId})" class="btn btn-success">Request New Keycard</button>                                                 
                                                    </center>
                                                </c:when>
                                            </c:choose>
                                        </div>
                    ...
                    <div class="row mt">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 desc">
                            <div class="white-panel pn donut-chart">
                                <div class="white-header">
                                    <h3 style="color:black;">Request History</h3>
                                </div>
                                <div class="row">
                                    <div class="col-sm-12">
