                    ...
                    <div class="row mt">
                        <div class="col-lg-12">
                            ...
                            <div class="form-panel" style="border-radius: 10px; padding-left: 20px;">
                                <%--form--%>      <div class="form-horizontal tasi-form" method="get">
                                    <br>
                                    ...
                                    <%if (m.getMtn_pic() != null) {%>
                                  <table>
                                      <tr>
                                            <%for (String path : m.getMtn_pic()) {%>
                <td><img src='<%= path%>' style="width:200px;height:150px;"></td>
                                                <%}%>
                                      </tr>
                                  </table>
                                    <%}%>
                              ...
                              <br>
                              <h4 style="color: black;">Evaluation Result</h4><br>
