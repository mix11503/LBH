<%-- 
    ...
    Created on : May 7, 2017, 4:40:59 PM
    Author     : Mix
--%>
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper">   
                    ...
                    <form action="MTNSearchDate" method="get">
                        <h3 align="right">Enter Date</h3><div align="right"><input type="date" name="date"> <input type="submit" value="search"></div>
                    </form>
