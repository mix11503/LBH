                                ...
                                <div class="white-panel pn white-header">
                                    ...
                                    <div style="height: 155px;">
                                        ...
                                        <div class="white-panel pn white-header" style="height: 40px;">                                            
                                            <form action="editNews" method="get" style='float:left;'><input type="text" name="id" value="<%=n.getNews_id()%>" hidden/><input type="submit" value="edit" class="btn btn-warning"/></form>           
